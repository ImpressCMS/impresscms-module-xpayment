 ...
 */
	...
	//Version 1.42
	define('_XPY_MI_MANUAL_PREFIX', 'Manual Transaction Prefix to Invoice Number');
	define('_XPY_MI_MANUAL_PREFIX_DESC', 'This prefix will appear before the invoice number for manual transactions');
?>