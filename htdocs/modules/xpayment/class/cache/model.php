 ...
 * @subpackage cake.cake.libs.cache
 */
class IcmsCacheModel extends IcmsCacheEngine
{
    /**
     * settings
    ...
    function init($settings)
    {
        ...
        $this->model = new IcmsCacheModelHandler($db);
        return true;
    }
    ...
    function gc()
    {
        return $this->model->deleteAll(new icms_db_criteria_Item($this->fields[1], time, '<= '));
    }
    ...
    function read($key)
    {
        $criteria = new icms_db_criteria_Compo(new icms_db_criteria_Item($this->model::KEYNAME, $key));
        $criteria->add(new icms_db_criteria_Item($this->fields[1], time(), ">"));
        $criteria->setLimit(1);
 ...
 * @access public
 */
class IcmsCacheModelObject extends IcmsObject
{
    function IcmsCacheModelObject()
    {
        $this->__construct();
    }
 ...
 * @access public
 */
class IcmsCacheModelHandler extends IcmsPersistableObjectHandler
{
    const TABLE = 'cache_model';
    const CLASSNAME = 'IcmsCacheModelObject';
    const KEYNAME = 'key';
}
