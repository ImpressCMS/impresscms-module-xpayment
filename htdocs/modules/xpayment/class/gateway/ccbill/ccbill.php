...
class CcbillGatewaysPlugin {
	...
	function __construct($invoice, $gateway) {
    	...
    	if (file_exists((ICMS_ROOT_PATH.'/modules/xpayment/language/'.$GLOBALS['icmsConfig']['language'].'/ccbill.php')))
    		include_once((ICMS_ROOT_PATH.'/modules/xpayment/language/'.$GLOBALS['icmsConfig']['language'].'/ccbill.php'));
    	else 
    		include_once((ICMS_ROOT_PATH.'/modules/xpayment/language/english/ccbill.php'));
	...
	function getPaymentHTML() {
		...
		$html .= '<div><form action="'.$this->_gateway->_options['url'].'" method="post">';
