 ...
 * @access 		public
 */
class icms_form_elements_SelectInvoiceMode extends icms_form_elements_Select
{
    /**
     * Constructor
     *
     ...
     */
    function icms_form_elements_SelectInvoiceMode($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
