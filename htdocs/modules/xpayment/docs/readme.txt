...
Downloads & Demo:
	...
	Download: http://bin.chronolabs.coop/icms2.5_xpayment_1.38.zip (6.13Mbs)
	Sourceforge: http://sourceforge.net/projects/chronolabs/files/ICMS/Modules/xpayment/icms2.5_xpayment_1.38.zip/download (6.13Mbs)
	Demo: http://icms.demo.chronolabs.coop
...
Standard Email Tags - Invoice
	...
	{SITEURL} = ICMS_URL
	{SITENAME} = $GLOBALS['icmsConfig']['sitename']
	...
	{BROKER_x_UID} = $icmsuser->getVar('uid')
	{BROKER_x_NAME} = $icmsuser->getVar('name')
	{BROKER_x_UNAME} = $icmsuser->getVar('uname')
	{BROKER_x_EMAIL} = $icmsuser->getVar('email')
	{BROKER_x_URL} = $icmsuser->getVar('url')
	{BROKER_x_USER_AVATA} = $icmsuser->getVar('user_avatar')
	{BROKER_x_USER_REGDATE} = $icmsuser->getVar('user_regdate')
	{BROKER_x_USER_ICQ} = $icmsuser->getVar('user_icq')
	{BROKER_x_USER_FROM} = $icmsuser->getVar('user_from')
	{BROKER_x_USER_SIG} = $icmsuser->getVar('user_sig')
	{BROKER_x_USER_VIEWEMAIL} = $icmsuser->getVar('user_viewemail')
	{BROKER_x_ACTKEY} = $icmsuser->getVar('actkey')
	{BROKER_x_USER_AIM} = $icmsuser->getVar('user_aim')
	{BROKER_x_USER_YIM} = $icmsuser->getVar('user_yim')
	{BROKER_x_USER_MSNM} = $icmsuser->getVar('user_msnm')
	{BROKER_x_PASS} = $icmsuser->getVar('pass')
	{BROKER_x_POSTS} = $icmsuser->getVar('posts')
	{BROKER_x_ATTACHSIG} = $icmsuser->getVar('attachsig')
	{BROKER_x_RANK} = $icmsuser->getVar('rank')
	{BROKER_x_LEVEL} = $icmsuser->getVar('level')
	{BROKER_x_THEME} = $icmsuser->getVar('theme')
	{BROKER_x_TIMEZONE_OFFSET} = $icmsuser->getVar('timezone_offset')
	{BROKER_x_LAST_LOGIN} = $icmsuser->getVar('last_login')
	{BROKER_x_UMODE} = $icmsuser->getVar('umode')
	{BROKER_x_UORDER} = $icmsuser->getVar('uorder')
	{BROKER_x_NOTIFY_METHOD} = $icmsuser->getVar('notify_method')
	{BROKER_x_NOTIFY_MODE} = $icmsuser->getVar('notify_mode')
	{BROKER_x_USER_OCC} = $icmsuser->getVar('user_occ')
	{BROKER_x_BIO} = $icmsuser->getVar('bio')
	{BROKER_x_USER_INTREST} = $icmsuser->getVar('user_intrest')
	{BROKER_x_USER_MAILOK} = $icmsuser->getVar('user_mailok')
	{BROKER_COUNT} = max(x);
	* If Profile Module is installed then the fields will also be included here as well in the broker profile.
	...
	{ACCOUNTS_x_UID} = $icmsuser->getVar('uid')
	{ACCOUNTS_x_NAME} = $icmsuser->getVar('name')
	{ACCOUNTS_x_UNAME} = $icmsuser->getVar('uname')
	{ACCOUNTS_x_EMAIL} = $icmsuser->getVar('email')
	{ACCOUNTS_x_URL} = $icmsuser->getVar('url')
	{ACCOUNTS_x_USER_AVATA} = $icmsuser->getVar('user_avatar')
	{ACCOUNTS_x_USER_REGDATE} = $icmsuser->getVar('user_regdate')
	{ACCOUNTS_x_USER_ICQ} = $icmsuser->getVar('user_icq')
	{ACCOUNTS_x_USER_FROM} = $icmsuser->getVar('user_from')
	{ACCOUNTS_x_USER_SIG} = $icmsuser->getVar('user_sig')
	{ACCOUNTS_x_USER_VIEWEMAIL} = $icmsuser->getVar('user_viewemail')
	{ACCOUNTS_x_ACTKEY} = $icmsuser->getVar('actkey')
	{ACCOUNTS_x_USER_AIM} = $icmsuser->getVar('user_aim')
	{ACCOUNTS_x_USER_YIM} = $icmsuser->getVar('user_yim')
	{ACCOUNTS_x_USER_MSNM} = $icmsuser->getVar('user_msnm')
	{ACCOUNTS_x_PASS} = $icmsuser->getVar('pass')
	{ACCOUNTS_x_POSTS} = $icmsuser->getVar('posts')
	{ACCOUNTS_x_ATTACHSIG} = $icmsuser->getVar('attachsig')
	{ACCOUNTS_x_RANK} = $icmsuser->getVar('rank')
	{ACCOUNTS_x_LEVEL} = $icmsuser->getVar('level')
	{ACCOUNTS_x_THEME} = $icmsuser->getVar('theme')
	{ACCOUNTS_x_TIMEZONE_OFFSET} = $icmsuser->getVar('timezone_offset')
	{ACCOUNTS_x_LAST_LOGIN} = $icmsuser->getVar('last_login')
	{ACCOUNTS_x_UMODE} = $icmsuser->getVar('umode')
	{ACCOUNTS_x_UORDER} = $icmsuser->getVar('uorder')
	{ACCOUNTS_x_NOTIFY_METHOD} = $icmsuser->getVar('notify_method')
	{ACCOUNTS_x_NOTIFY_MODE} = $icmsuser->getVar('notify_mode')
	{ACCOUNTS_x_USER_OCC} = $icmsuser->getVar('user_occ')
	{ACCOUNTS_x_BIO} = $icmsuser->getVar('bio')
	{ACCOUNTS_x_USER_INTREST} = $icmsuser->getVar('user_intrest')
	{ACCOUNTS_x_USER_MAILOK} = $icmsuser->getVar('user_mailok')
	...
	* If Profile Module is installed then the fields will also be included here as well in the accounts profile.
	...
	{OFFICERS_x_UID} = $icmsuser->getVar('uid')
	{OFFICERS_x_NAME} = $icmsuser->getVar('name')
	{OFFICERS_x_UNAME} = $icmsuser->getVar('uname')
	{OFFICERS_x_EMAIL} = $icmsuser->getVar('email')
	{OFFICERS_x_URL} = $icmsuser->getVar('url')
	{OFFICERS_x_USER_AVATA} = $icmsuser->getVar('user_avatar')
	{OFFICERS_x_USER_REGDATE} = $icmsuser->getVar('user_regdate')
	{OFFICERS_x_USER_ICQ} = $icmsuser->getVar('user_icq')
	{OFFICERS_x_USER_FROM} = $icmsuser->getVar('user_from')
	{OFFICERS_x_USER_SIG} = $icmsuser->getVar('user_sig')
	{OFFICERS_x_USER_VIEWEMAIL} = $icmsuser->getVar('user_viewemail')
	{OFFICERS_x_ACTKEY} = $icmsuser->getVar('actkey')
	{OFFICERS_x_USER_AIM} = $icmsuser->getVar('user_aim')
	{OFFICERS_x_USER_YIM} = $icmsuser->getVar('user_yim')
	{OFFICERS_x_USER_MSNM} = $icmsuser->getVar('user_msnm')
	{OFFICERS_x_PASS} = $icmsuser->getVar('pass')
	{OFFICERS_x_POSTS} = $icmsuser->getVar('posts')
	{OFFICERS_x_ATTACHSIG} = $icmsuser->getVar('attachsig')
	{OFFICERS_x_RANK} = $icmsuser->getVar('rank')
	{OFFICERS_x_LEVEL} = $icmsuser->getVar('level')
	{OFFICERS_x_THEME} = $icmsuser->getVar('theme')
	{OFFICERS_x_TIMEZONE_OFFSET} = $icmsuser->getVar('timezone_offset')
	{OFFICERS_x_LAST_LOGIN} = $icmsuser->getVar('last_login')
	{OFFICERS_x_UMODE} = $icmsuser->getVar('umode')
	{OFFICERS_x_UORDER} = $icmsuser->getVar('uorder')
	{OFFICERS_x_NOTIFY_METHOD} = $icmsuser->getVar('notify_method')
	{OFFICERS_x_NOTIFY_MODE} = $icmsuser->getVar('notify_mode')
	{OFFICERS_x_USER_OCC} = $icmsuser->getVar('user_occ')
	{OFFICERS_x_BIO} = $icmsuser->getVar('bio')
	{OFFICERS_x_USER_INTREST} = $icmsuser->getVar('user_intrest')
	{OFFICERS_x_USER_MAILOK} = $icmsuser->getVar('user_mailok')
