...
$GLOBALS['xpaymentImageAdmin'] = $GLOBALS['xpaymentModule']->getInfo('icons32');

global $adminmenu;
$adminmenu=array();
$adminmenu[0]['title'] = _XPY_ADMENU8;
$adminmenu[0]['icon'] = $GLOBALS['xpaymentImageAdmin'].'/home.png';
$adminmenu[0]['image'] = $GLOBALS['xpaymentImageAdmin'].'/home.png';
...
$adminmenu[8]['icon'] = $GLOBALS['xpaymentImageAdmin'].'/about.png';
$adminmenu[8]['image'] = $GLOBALS['xpaymentImageAdmin'].'/about.png';
